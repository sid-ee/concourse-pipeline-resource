...
func (fake *FakeClient) URL() string {
	...
	fake.guard("URL")
	fake.invocations["URL"] = append(fake.invocations["URL"], []interface{}{})
...
func (fake *FakeClient) HTTPClient() *http.Client {
	...
	fake.guard("HTTPClient")
	fake.invocations["HTTPClient"] = append(fake.invocations["HTTPClient"], []interface{}{})
...
func (fake *FakeClient) Builds(arg1 concourse.Page) ([]atc.Build, concourse.Pagination, error) {
	...
	fake.guard("Builds")
	fake.invocations["Builds"] = append(fake.invocations["Builds"], []interface{}{arg1})
...
func (fake *FakeClient) Build(buildID string) (atc.Build, bool, error) {
	...
	fake.guard("Build")
	fake.invocations["Build"] = append(fake.invocations["Build"], []interface{}{buildID})
...
func (fake *FakeClient) BuildEvents(buildID string) (concourse.Events, error) {
	...
	fake.guard("BuildEvents")
	fake.invocations["BuildEvents"] = append(fake.invocations["BuildEvents"], []interface{}{buildID})
...
func (fake *FakeClient) BuildResources(buildID int) (atc.BuildInputsOutputs, bool, error) {
	...
	fake.guard("BuildResources")
	fake.invocations["BuildResources"] = append(fake.invocations["BuildResources"], []interface{}{buildID})
...
func (fake *FakeClient) AbortBuild(buildID string) error {
	...
	fake.guard("AbortBuild")
	fake.invocations["AbortBuild"] = append(fake.invocations["AbortBuild"], []interface{}{buildID})
...
func (fake *FakeClient) BuildInputsForJob(pipelineName string, jobName string) ([]atc.BuildInput, bool, error) {
	...
	fake.guard("BuildInputsForJob")
	fake.invocations["BuildInputsForJob"] = append(fake.invocations["BuildInputsForJob"], []interface{}{pipelineName, jobName})
...
func (fake *FakeClient) CreateBuild(plan atc.Plan) (atc.Build, error) {
	...
	fake.guard("CreateBuild")
	fake.invocations["CreateBuild"] = append(fake.invocations["CreateBuild"], []interface{}{plan})
...
func (fake *FakeClient) CreateJobBuild(pipelineName string, jobName string) (atc.Build, error) {
	...
	fake.guard("CreateJobBuild")
	fake.invocations["CreateJobBuild"] = append(fake.invocations["CreateJobBuild"], []interface{}{pipelineName, jobName})
...
func (fake *FakeClient) BuildPlan(buildID int) (atc.PublicBuildPlan, bool, error) {
	...
	fake.guard("BuildPlan")
	fake.invocations["BuildPlan"] = append(fake.invocations["BuildPlan"], []interface{}{buildID})
...
func (fake *FakeClient) CreateOrUpdatePipelineConfig(pipelineName string, configVersion string, passedConfig atc.Config) (bool, bool, []concourse.ConfigWarning, error) {
	...
	fake.guard("CreateOrUpdatePipelineConfig")
	fake.invocations["CreateOrUpdatePipelineConfig"] = append(fake.invocations["CreateOrUpdatePipelineConfig"], []interface{}{pipelineName, configVersion, passedConfig})
...
func (fake *FakeClient) CreatePipe() (atc.Pipe, error) {
	...
	fake.guard("CreatePipe")
	fake.invocations["CreatePipe"] = append(fake.invocations["CreatePipe"], []interface{}{})
...
func (fake *FakeClient) PausePipeline(pipelineName string) (bool, error) {
	...
	fake.guard("PausePipeline")
	fake.invocations["PausePipeline"] = append(fake.invocations["PausePipeline"], []interface{}{pipelineName})
...
func (fake *FakeClient) UnpausePipeline(pipelineName string) (bool, error) {
	...
	fake.guard("UnpausePipeline")
	fake.invocations["UnpausePipeline"] = append(fake.invocations["UnpausePipeline"], []interface{}{pipelineName})
...
func (fake *FakeClient) RenamePipeline(pipelineName string, name string) (bool, error) {
	...
	fake.guard("RenamePipeline")
	fake.invocations["RenamePipeline"] = append(fake.invocations["RenamePipeline"], []interface{}{pipelineName, name})
...
func (fake *FakeClient) Job(pipelineName string, jobName string) (atc.Job, bool, error) {
	...
	fake.guard("Job")
	fake.invocations["Job"] = append(fake.invocations["Job"], []interface{}{pipelineName, jobName})
...
func (fake *FakeClient) JobBuild(pipelineName string, jobName string, buildName string) (atc.Build, bool, error) {
	...
	fake.guard("JobBuild")
	fake.invocations["JobBuild"] = append(fake.invocations["JobBuild"], []interface{}{pipelineName, jobName, buildName})
...
func (fake *FakeClient) JobBuilds(pipelineName string, jobName string, page concourse.Page) ([]atc.Build, concourse.Pagination, bool, error) {
	...
	fake.guard("JobBuilds")
	fake.invocations["JobBuilds"] = append(fake.invocations["JobBuilds"], []interface{}{pipelineName, jobName, page})
...
func (fake *FakeClient) PauseJob(pipelineName string, jobName string) (bool, error) {
	...
	fake.guard("PauseJob")
	fake.invocations["PauseJob"] = append(fake.invocations["PauseJob"], []interface{}{pipelineName, jobName})
...
func (fake *FakeClient) UnpauseJob(pipelineName string, jobName string) (bool, error) {
	...
	fake.guard("UnpauseJob")
	fake.invocations["UnpauseJob"] = append(fake.invocations["UnpauseJob"], []interface{}{pipelineName, jobName})
...
func (fake *FakeClient) ListContainers(queryList map[string]string) ([]atc.Container, error) {
	...
	fake.guard("ListContainers")
	fake.invocations["ListContainers"] = append(fake.invocations["ListContainers"], []interface{}{queryList})
...
func (fake *FakeClient) ListPipelines() ([]atc.Pipeline, error) {
	...
	fake.guard("ListPipelines")
	fake.invocations["ListPipelines"] = append(fake.invocations["ListPipelines"], []interface{}{})
...
func (fake *FakeClient) ListVolumes() ([]atc.Volume, error) {
	...
	fake.guard("ListVolumes")
	fake.invocations["ListVolumes"] = append(fake.invocations["ListVolumes"], []interface{}{})
...
func (fake *FakeClient) ListWorkers() ([]atc.Worker, error) {
	...
	fake.guard("ListWorkers")
	fake.invocations["ListWorkers"] = append(fake.invocations["ListWorkers"], []interface{}{})
...
func (fake *FakeClient) GetInfo() (atc.Info, error) {
	...
	fake.guard("GetInfo")
	fake.invocations["GetInfo"] = append(fake.invocations["GetInfo"], []interface{}{})
...
func (fake *FakeClient) GetCLIReader(arch string, platform string) (io.ReadCloser, error) {
	...
	fake.guard("GetCLIReader")
	fake.invocations["GetCLIReader"] = append(fake.invocations["GetCLIReader"], []interface{}{arch, platform})
...
func (fake *FakeClient) ListAuthMethods() ([]atc.AuthMethod, error) {
	...
	fake.guard("ListAuthMethods")
	fake.invocations["ListAuthMethods"] = append(fake.invocations["ListAuthMethods"], []interface{}{})
...
func (fake *FakeClient) AuthToken() (atc.AuthToken, error) {
	...
	fake.guard("AuthToken")
	fake.invocations["AuthToken"] = append(fake.invocations["AuthToken"], []interface{}{})
...
func (fake *FakeClient) Pipeline(name string) (atc.Pipeline, bool, error) {
	...
	fake.guard("Pipeline")
	fake.invocations["Pipeline"] = append(fake.invocations["Pipeline"], []interface{}{name})
...
func (fake *FakeClient) Resource(pipelineName string, resourceName string) (atc.Resource, bool, error) {
	...
	fake.guard("Resource")
	fake.invocations["Resource"] = append(fake.invocations["Resource"], []interface{}{pipelineName, resourceName})
...
func (fake *FakeClient) ResourceVersions(pipelineName string, resourceName string, page concourse.Page) ([]atc.VersionedResource, concourse.Pagination, bool, error) {
	...
	fake.guard("ResourceVersions")
	fake.invocations["ResourceVersions"] = append(fake.invocations["ResourceVersions"], []interface{}{pipelineName, resourceName, page})
...
func (fake *FakeClient) CheckResource(pipelineName string, resourceName string, version atc.Version) (bool, error) {
	...
	fake.guard("CheckResource")
	fake.invocations["CheckResource"] = append(fake.invocations["CheckResource"], []interface{}{pipelineName, resourceName, version})
...
func (fake *FakeClient) BuildsWithVersionAsInput(pipelineName string, resourceName string, resourceVersionID int) ([]atc.Build, bool, error) {
	...
	fake.guard("BuildsWithVersionAsInput")
	fake.invocations["BuildsWithVersionAsInput"] = append(fake.invocations["BuildsWithVersionAsInput"], []interface{}{pipelineName, resourceName, resourceVersionID})
...
func (fake *FakeClient) BuildsWithVersionAsOutput(pipelineName string, resourceName string, resourceVersionID int) ([]atc.Build, bool, error) {
	...
	fake.guard("BuildsWithVersionAsOutput")
	fake.invocations["BuildsWithVersionAsOutput"] = append(fake.invocations["BuildsWithVersionAsOutput"], []interface{}{pipelineName, resourceName, resourceVersionID})
...
func (fake *FakeClient) SetTeam(teamName string, team atc.Team) (atc.Team, bool, bool, error) {
	...
	fake.guard("SetTeam")
	fake.invocations["SetTeam"] = append(fake.invocations["SetTeam"], []interface{}{teamName, team})
